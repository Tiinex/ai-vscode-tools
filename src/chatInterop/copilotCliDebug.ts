...
export function renderCopilotCliCapabilityProbePackMarkdown(probePack: CopilotCliCapabilityProbePack): string {
  return [
    ...
    "",
    "## Commands",
    "- Agent Architect Tools: Probe Latest Copilot CLI Read Access",
    "- Agent Architect Tools: Probe Latest Copilot CLI Workspace Mutation",
    "- Agent Architect Tools: Probe Latest Copilot CLI Tool Approval",
    "",
    "## What To Observe",
